...
export default function CarouselPrimeLux() {
    ...
    const prevId = `prime-lux-prev-${Math.random().toString(36).substr(2, 9)}`;
    const nextId = `prime-lux-next-${Math.random().toString(36).substr(2, 9)}`;
